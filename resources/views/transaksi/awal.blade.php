			...
			<table class="table">
						...
						<tbody>
								...
								@foreach ($data as $transaksi)
									<tr>
									<td>{{ $x++ }}</td>
									<td>{{ $transaksi->nama_transaksi or 'nama_transaksi kosong'}}</td>
									<td>{{ $transaksi->tgl_transaksi or 'tgl_transaksi kosong'}}</td>
									<td>{{ $transaksi->total_bayar or 'total_bayar kosong'}}</td>
									<td>{{ $transaksi->id_konsumen or 'konsumen kosong'}}</td>
									<td>
